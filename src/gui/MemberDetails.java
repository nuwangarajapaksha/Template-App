...
public class MemberDetails extends javax.swing.JFrame {
    ...
    public MemberDetails(String info[]) {
        initComponents();
        nameField.setText(info[0]);
        nicField.setText(info[1]);
        addressField.setText(info[2]);
        workPlaceField.setText(info[3]);
        schoolField.setText(info[4]);
        parentNameField.setText(info[5]);
        contactNoField.setText(info[6]);
    }
